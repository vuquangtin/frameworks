...
public class QuartzManager {
	...
	public static void modifyJobTime(String jobName, String time) {
		try {
			...
			CronTrigger trigger = (CronTrigger) scheduler
					.getTriggersOfJob(new JobKey(jobName, TRIGGER_GROUP_NAME));
			if (trigger == null) {
				return;
			}
	...
	public static void modifyJobTime(String triggerName,
		...
		try {
			...
			CronTrigger trigger = (CronTrigger) sched
					.getTriggersOfJob(new JobKey(triggerName, triggerGroupName));
			if (trigger == null) {
				return;
			}
			String oldTime = trigger.getCronExpression();
	...
	public static void removeJob(String jobName) {
		try {
			Scheduler sched = gSchedulerFactory.getScheduler();
			sched.pauseJob(new JobKey(jobName, TRIGGER_GROUP_NAME));// 停止触发器
	...
	public static void removeJob(String jobName, String jobGroupName,
		...
		try {
			Scheduler sched = gSchedulerFactory.getScheduler();
			sched.pauseJob(new JobKey(triggerName, triggerGroupName));// 停止触发器
