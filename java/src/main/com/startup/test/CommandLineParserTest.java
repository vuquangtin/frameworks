...
public class CommandLineParserTest {
	...
	/**
	 * Test that a invalid input exception is not thrown with a valid command
	 * line input
	 */
	@Test
	...
	/**
	 * Test that a NumberFormatException is caught when the second argument is
	 * not a number
	 * 
	...
	/**
	 * Test that a InvalidInputException is caught when no arguments are passed
	 * in
	 */
	@Test
	...
	/**
	 * Test that an InvalidInputException is caught when 0 processors have been
	 * specified
	 */
	@Test
	...
	/**
	 * Test that an InvalidInputException is caught when 0 cores have been
	 * inputted
	 */
	@Test
	public void parseIncorrectCores() {
		...
		try {
			...
			assertEquals("Please enter a valid number of cores (processors) for paralellising the search",
					e.getMessage());
		}
	}

	/**
	 * Test that an InvalidInputException is caught, and the correct error
	 * message has been displayed when a file with no .dot file has been
	 * inputted
	 */
	@Test
