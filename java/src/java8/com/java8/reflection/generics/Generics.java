...
public class Generics {
	...
	private static void typeToString(StringBuilder sb, Type type, Set<Type> visited) {
		if (type instanceof ParameterizedType) {
			...
			/*
			 * According to
			 * JLS(http://java.sun.com/docs/books/jls/third_edition/html/
			 * typesValues.html#4.5.1): - Lower and upper can't coexist: (for
			 * instance, this is not allowed: <? extends List<String> & super
			 * MyInterface>) - Multiple bounds are not supported (for instance,
			 * this is not allowed: <? extends List<String> & MyInterface>)
			 */
			final Type bound;
