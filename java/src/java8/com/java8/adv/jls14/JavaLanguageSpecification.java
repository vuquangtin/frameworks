 ...
 *
 */
public class JavaLanguageSpecification extends TemplateMethod implements
		IExtendTemplateMethod {

	public static void main(String[] args) {
		JavaLanguageSpecification item = new JavaLanguageSpecification();
		item.runTemplateMethod(args, item);
	}
