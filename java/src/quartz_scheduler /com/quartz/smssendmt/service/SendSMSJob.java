...
public class SendSMSJob implements Job {
	...
	private static final MtStub stub = new MtStub(ConfigurationManagement.getInstance().getString("sms.url"),
			"http://tempuri.org/", ConfigurationManagement.getInstance().getString("sms.username"),
	...
	public static int sendMT(String receiver, String content) {
		...
		// content, status
		return stub.send("0", "0", ConfigurationManagement.getInstance().getString("sms.sender"), receiver, "0",
				content, "0");
	}
}
